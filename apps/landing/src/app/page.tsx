        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button size='sm' variant="primary" className="px-4 py-2 font-semibold">Launch App</Button>
            </div>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4 font-accent">
              How SuperPool Works
            </h2>
            ...
            {features.map((feature, index) => (
              <div key={index} className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-4 font-accent">
                    {feature.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <div className="flex space-x-4">
                <Button variant="ghost" size="sm" className="px-4 py-2">GitHub</Button>
                <Button variant="ghost" size="sm" className="px-4 py-2">Twitter</Button>
                <Button variant="ghost" size="sm" className="px-4 py-2">Discord</Button>
              </div>
            </div>
            <div>
