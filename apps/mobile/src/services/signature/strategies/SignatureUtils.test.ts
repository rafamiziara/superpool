...
describe('SignatureUtils', () => {
    ...
    describe('createTimeoutPromise', () => {
      ...
      it('should include operation name in error message', async () => {
        ...
        await expect(timeoutPromise).rejects.toThrow(
          'Custom signing operation timed out after 1 seconds'
        )
      })
    ...
    describe('withTimeout', () => {
      ...
      it('should handle promise rejection after timeout', async () => {
        const slowFailingPromise = new Promise((_, reject) => 
          setTimeout(() => reject(new Error('Late failure')), 10000)
        )
    ...
    describe('isValidSignatureFormat', () => {
      ...
      it('should return true for valid Safe wallet tokens', () => {
        const validSafeTokens = [
          'safe-wallet:0x123:nonce123:1234567890',
          'safe-wallet:0xabcdef:abc:999',
          'safe-wallet:0x0:n:1'
        ]
  ...
  describe('Safe Wallet Token Creation', () => {
    describe('createSafeAuthToken', () => {
      ...
      it('should handle different nonces', () => {
        const differentNonces = [
          '',
          '0',
          '123',
          'long-nonce-with-special-chars-!@#$%',
          'unicode-nonce-测试'
        ]
    ...
    describe('logSignaturePreview', () => {
      ...
      it('should log signature preview with correct format', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(
          '✅ Personal message signature successful:',
          'string',
          '0x12345678...'
        )
      })
      ...
      it('should truncate long signatures correctly', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(
          '✅ Long signature signature successful:',
          'string',
          '0xaaaaaaaa...'
        )
      })
      ...
      it('should handle special characters in signatures', () => {
        const specialSignatures = [
          'special-signature:with!@#$%^&*()',
          '0x123-456_789',
          'unicode-测试-signature'
        ]
      ...
      it('should always show string type regardless of signature content', () => {
        ...
        signatures.forEach(signature => {
          ...
          expect(consoleSpy).toHaveBeenCalledWith(
            expect.stringContaining('✅ Test signature successful:'),
            'string',
            expect.any(String)
          )
        })
  ...
  describe('Static Class Behavior', () => {
    ...
    it('should have consistent method naming', () => {
      ...
      const functionMethods = methods.filter(name => 
        typeof SignatureUtils[name as keyof typeof SignatureUtils] === 'function'
      )
