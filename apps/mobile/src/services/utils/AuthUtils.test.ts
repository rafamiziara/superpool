...
describe('AuthUtils', () => {
  ...
  describe('isHexSignature', () => {
    it('should identify valid hex signatures', () => {
      ...
      const longHex = '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1b'
  ...
  describe('determineSignatureType', () => {
    ...
    it('should identify hex signatures', () => {
      const hexSignature = '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1b'
