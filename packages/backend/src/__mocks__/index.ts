...
} from './firebase/FirebaseAdminMock'

export type {
  MockTransactionResponse,
  MockTransactionReceipt,
} from './blockchain/EthersMock'

export type {
  PoolCreatedEvent,
  SafeTransactionData,
} from './blockchain/ContractMock'

export type {
  TestCallableRequest,
  MockHttpsError,
  CloudFunctionTestOptions,
} from '../__tests__/utils/CloudFunctionTester'

export type {
  ChainConfig,
  ContractConfig,
  TestWalletConfig,
  BlockchainTestOptions,
} from '../__tests__/utils/BlockchainTestEnvironment'
...
export class MockFactory {
   ...
   */
  static createCloudFunctionEnvironment(options: {
    withAuth?: boolean
  ...
  static createAuthenticationScenario(walletAddress?: string) {
    ...
    // Create auth message
    const message = TestFixtures.SAMPLE_AUTH_MESSAGES.VALID_MESSAGE(
      address,
      nonce.nonce,
      nonce.timestamp
    )
