...
Empty this when a feature closes. `.dev/` rotted into a junk drawer precisely because
being gitignored let it accept anything without consequence; this folder only stays
useful if clearing it is routine.
